...
buttons.forEach(button => button.addEventListener('click', function clickHandler(event) {
    ...
    showCategory(products[event.target.dataset.type]);
}));
...
function showCategory(category) {
    ...
    category.forEach(product => getProductMarkup(product));
